...
# Refer - video - https://www.youtube.com/watch?v=W6KS9-kFObc

    def carFleet(self, target: int, position: List[int], speed: List[int]) -> int:

        fleet = 0

        # zip function is used to combine the position and speed lists into a iterator of tuples (zip(position, speed))
        # sort the iterator of tuples based on the position in descending order and produces the list as output sorted((zip(position, speed)), reverse=True)
